      ...
      <nav  className="page__menu menu" id="menu">
        <div className="menu__content">
          ...
          <ul className="menu__list">
            ...
            <li className="menu__item"><a href="#presentation" className="menu__link">OUR STORY</a></li>
            <li className="menu__item"><a href="#aboutUS" className="menu__link">ABOUT US</a></li>
            <li className="menu__item"><a href="#technology" className="menu__link">TECHNOLOGY</a></li>
            <li className="menu__item"><a href="#features" className="menu__link">FEATURES</a></li>
            <li className="menu__item"><a href="#questions" className="menu__link">GET IN TOUCH</a></li>
          </ul>
        </div>
      </nav>
    </header>
